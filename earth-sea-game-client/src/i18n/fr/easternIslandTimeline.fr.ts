...
export const EasternNationTimeline: Language["timelines"]["easternIsland"] = {
    ...
    secondStraitCrisis: {
        ...
        details:
            "Désormais supportée par la Nation du Nord, le gouvernement de la Renaissance tente une nouvelle fois d'envahir l'Île Orientale. La Nation Des Mers réagit avec trois porte-avions et ordonne le déploiement préventif de ses forces nucléaires.",
    },
    sinkingOfTheNepture: {
        event: "Naufrage du Nepture",
        details:
            "Le Neptune, navire de croisière battant le pavillon de la Nation Des Mers explose à quelques milles nautiques de l'Île Orientale.",
    },
};
