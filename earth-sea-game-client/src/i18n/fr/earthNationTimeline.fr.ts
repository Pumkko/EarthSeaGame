...
export const EarthNationTimelineFr: Language["timelines"]["earthNation"] = {
    ...
    greatWarEnds: {
        ...
        details:
            "La Nation Reculée capitule après avoir vu ses trois plus grandes villes détruites par des bombardements atomiques. La Grande Guerre est terminée, plus de 80 millions de personnes y ont perdu la vie. Le Continent principal lieu des combats est ravagée, la population décimée. La Nation Des Mers devient de très loin l'état le plus puissant du monde et seul doté de l'arme nucléaire.",
    },
    rebirthOfTheNation: {
