...
const frDefinition = {
    ...
    timelines: {
        earthNation: {
            ...
            civilWar: "Début de la Première Guerre Civile",
            atomicBombings: "Bombardements Atomiques de la Nation Reculée",
            cohabitationTreaty: "Traité de Cohabitation",
            ...
            seaNationProtectionTreaty: "Traité de Protection",
            secondCivilWarBegins: "Début de la Deuxième Guerre Civile",
            secondStraitCrisis: "Deuxième crise du détroit",
            sinkingOfTheNepture: "Naufrage du Nepture",
            southerNationBorderConflict: "Guerre contre la Nation du Sud",
            southernNationIndependence: "Indépendance de la Nation du Sud",
            treatyOfUnity: "Traité d'Unité",
